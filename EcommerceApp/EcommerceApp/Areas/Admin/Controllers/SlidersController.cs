...
public class SlidersController : Controller
{
    ...
    public async Task<IActionResult> Create(Slider slider, IFormFile? Image)
    {
        ...
        {
            slider.ImageUrl = FileHelper.FileLoader(Image);
            _context.Add(slider);
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int id, Slider slider, IFormFile? Image, bool DelImg)
    {
        if (id != slider.Id)
        {
            return NotFound();
        ...
        if (ModelState.IsValid)
        {
            try
            {
                ...
                if (DelImg)
                {
                    ...
                    FileHelper.FileTerminator(slider.ImageUrl);
                }
